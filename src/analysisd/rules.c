...
int Rules_OP_ReadRules(char * rulefile)
{
    ...
    char *xml_srcgeoip = "srcgeoip";
    char *xml_srcport = "srcport";
    char *xml_dstip = "dstip";
    char *xml_dstgeoip = "dstgeoip";
    ...
    char *xml_different_geoip = "different_geoip";
                         ...
                         int ignore_time, int overwrite)
{
    ...
    ruleinfo_pt->srcgeoip = NULL; 
    ruleinfo_pt->dstgeoip = NULL; 
