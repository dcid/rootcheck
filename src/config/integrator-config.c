/* @(#) $Id: ./src/config/integrator-config.c, 2014/05/04 dcid Exp $
 */
...
int Read_Integrator(XML_NODE node, void *config, void *config2)
{
    int i = 0,s = 0;
    ...
    IntegratorConfig **integrator_config = (IntegratorConfig **)gen_config->data;
